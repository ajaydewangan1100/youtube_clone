...
const LeftNav = () => {
  ...
  return (
    <div className={`md:block w-[240px] overflow-y-auto h-full py-4 bg-black absolute md:relative z-10  md:translate-x-0 transition-all scrollbar:!w-1.5 scrollbar:bg-transparent  ${
